...
The only dependencies you need are a Nodejs environment and the Expressjs framework (jQuery library is loaded by CDN). If you want to download the jQuery library to not depend on the Internet Network connectivity, you're free to do that (I think I'll be going to do it as well).
...
# Acknowledgments:
About the HSV to RGB and RGB to HSV color domain conversion routines for ESP32, I took the version of ratkins user:
